...
export function QuadrantRotate({
  ...
  useEffect(() => {
    ...
    rotationTL.value = createRotationAnimation(
      durations[0],
      pauseDurations[0],
      startDelays[0],
      initialRotations[0]
    );
    rotationTR.value = createRotationAnimation(
      durations[1],
      pauseDurations[1],
      startDelays[1],
      initialRotations[1]
    );
    rotationBL.value = createRotationAnimation(
      durations[2],
      pauseDurations[2],
      startDelays[2],
      initialRotations[2]
    );
    rotationBR.value = createRotationAnimation(
      durations[3],
      pauseDurations[3],
      startDelays[3],
      initialRotations[3]
    ...
    <View style={styles.wrapper}>
      ...
      {showLoadingText && (
        <View style={styles.loadingTextContainer}>
          ...
          <Animated.Text
            style={[styles.dots, dotsOpacity1, { color: textColor }]}
          >
            .
          </Animated.Text>
          <Animated.Text
            style={[styles.dots, dotsOpacity2, { color: textColor }]}
          >
            .
          </Animated.Text>
          <Animated.Text
            style={[styles.dots, dotsOpacity3, { color: textColor }]}
          >
            .
          </Animated.Text>
        </View>
