const TASK_SCREEN_STRINGS = {
  ...
  addTask: {
    ...
    alerts: {
      ...
      aiGenerateMessage:
        'Please enter a task title first, then AI can help you generate subtasks!',
      aiGeneratePlaceholder:
        'This will call the backend API in the future to automatically generate subtasks based on the title.',
      errorTitle: 'Error',
